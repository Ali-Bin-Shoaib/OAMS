...
function EditEmployeeForm({
	...
	return (
		<>
			<button
				onClick={handleShow}
				className='px-4 py-1 text-sm text-stone-600 font-semibold rounded-full border border-stone-200 hover:text-white hover:bg-stone-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-stone-600 focus:ring-offset-2'>
				Edit
			</button>
