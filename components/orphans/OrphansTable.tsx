...
function OrphansTable({ orphans, updateCard }: Props) {
	const columns = useMemo<MRT_ColumnDef<Orphan>[]>(
		() => [
			...
			{ accessorFn: (row) => row.birthplace, id: 'birthplace', header: 'birthplace', maxSize: 200, size: 150, enableResizing: true },
			{ accessorFn: (row) => row.joinDate?.toDateString(), id: 'joinDate', header: 'joinDate' },
			{ accessorFn: (row) => row.schoolName, id: 'schoolName', header: 'schoolName', maxSize: 200, size: 150, enableResizing: true },
			{ accessorFn: (row) => row.gradeLevel, id: 'gradeLevel', header: 'gradeLevel', maxSize: 200, size: 150, enableResizing: true },
			{
			...
			{ accessorFn: (row) => row.fatherWork, id: 'fatherWork', header: 'fatherWork', maxSize: 200, size: 150, enableResizing: true },
			{
			...
			{ accessorFn: (row) => row.monthlyIncome, id: 'monthlyIncome', header: 'monthlyIncome', maxSize: 200, size: 150, enableResizing: true },
			{ accessorFn: (row) => row.liveWith, id: 'liveWith', header: 'liveWith', maxSize: 200, size: 150, enableResizing: true },
			{ accessorFn: (row) => row.homeType, id: 'homeType', header: 'homeType', maxSize: 200, size: 150, enableResizing: true },
			{ accessorFn: (row) => row.homePhone, id: 'homePhone', header: 'homePhone', maxSize: 200, size: 150, enableResizing: true },
			{
			...
			{ accessorFn: (row) => row.evaluation, id: 'evaluation', header: 'evaluation', maxSize: 200, size: 150, enableResizing: true },
		],
		[]
	);
